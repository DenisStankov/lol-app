          ...
          >
            ...
            <div className="relative aspect-video">
              ...
              <div className="absolute bottom-2 left-2 right-2 flex justify-between items-end">
                <div>
                  <h3 className="text-lg font-bold text-slate-100">{ability.name}</h3>
          ...
          <div className="relative">
            ...
            <div className="relative z-10 flex justify-between">
              {Array.from({ length: 18 }).map((_, index) => {
                const skillIndex = index < champion.skillOrder?.length ? champion.skillOrder[index] : null
                const ability = skillIndex !== null ? champion.abilities[skillIndex] : null
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/30">
              ...
              <div className="flex items-center space-x-2">
                {champion.abilities.slice(0, 1).map((ability: any) => (
                  <div key={ability.id} className="relative w-12 h-12 rounded-lg overflow-hidden">
                    <Image
                      src={ability.iconUrl || "/placeholder.svg"}
                      alt={ability.name}
                      fill
